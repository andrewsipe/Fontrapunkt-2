 ...
 * Uses react-dropzone, react-hot-toast. No Radix dependencies.
 */
        ...
        <div className={styles.dropOverlay}>
          <div className={styles.dropMessage}>
            {loading ? (
              ...
              <>
                <p className={styles.dropTitle}>Drop font file here</p>
                <p className={styles.dropSubtitle}>Supported Fontfiles</p>
